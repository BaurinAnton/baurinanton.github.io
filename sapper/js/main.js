...
Vue.component('game-footer', {
    ...
    В данном случае, есть 16 ячеек. <br/> В некоторых из них спрятаны бомбы. <br/> Нужно не подорваться на них! <br/> Открываем клеточку и видим цифру. <br/> Она означает, что в радиусе одной клетки данной клетки (вокруг неё) есть бобма,а количество их записано в клетке (та самая циферка). <br/> И нужно открыть все клеточки, минуя бомбы. <br/> УДАЧИ!</p></transition>
    </div>`
})
